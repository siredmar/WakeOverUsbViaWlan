...
function KeyModifiers()
{
	...
	console.log("CK" + KeyboardModifiers + "\t0");
   keyops.push("CK" + KeyboardModifiers + "\t0");
}

function KeySetModifiers(modifiers)
{
...
function SpecKey( k, code )
{
    ...
    keyops.push("CK" + KeyboardModifiers + "\t0");
    console.log("CK" + KeyboardModifiers + "\t" + code );
    console.log("CK" + KeyboardModifiers + "\t0");
}
...
function Keypress(id, type, shift) {
    ...
    if (type == 1) 
    {
      keyops.push("CK" + mods + "\t" + id); // Need a sanity check;
      console.log("Push: CK" + mods + "\t" + id); // Need a sanity check;
    }
      
    if (type == 0) 
    {
      keyops.push("CK" + KeyboardModifiers + "\t0");
      console.log("Release: CK" + KeyboardModifiers + "\t0");
    }
}
